...
`.replace(/(<([^>]+)>)/gi, "");
  ...
  protected getHtmlBody(): string {
    ...
    <body style="word-spacing:normal;background-color:#000000;">
      <div style="background-color:#000000;">
        ...
        <div style="background:#0000000;background-color:#0000000;margin:0px auto;max-width:600px;">
          <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="background:#0000000;background-color:#0000000;width:100%;">
            <tbody>
              <tr>
                <td style="border-left:1px solid #373737;border-right:1px solid #373737;direction:ltr;font-size:0px;padding:0px;text-align:center;">
                      ...
                      <tbody>
                        <tr>
                          <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                            <div style="font-family:Roboto, Helvetica, sans-serif;font-size:16px;font-weight:500;line-height:1;text-align:left;color:#ffffff;">
                              ${this.getWhat()}
                              ${this.getWhen()}
                              ${this.getWho()}
                              ${this.getLocation()}
        ...
        <div style="background:#000000;background-color:#000000;margin:0px auto;max-width:600px;">
          <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="background:#000000;background-color:#000000;width:100%;">
            <tbody>
              <tr>
                <td style="border-bottom:1px solid #373737;border-left:1px solid #373737;border-right:1px solid #373737;direction:ltr;font-size:0px;padding:0px;text-align:center;">
                  <!--[if mso | IE]><table role="presentation" border="0" cellpadding="0" cellspacing="0"><tr><td class="" style="vertical-align:top;width:598px;" ><![endif]-->
                  <div class="mj-column-per-100 mj-outlook-group-fix" style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;">
                    <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
                      <tbody>
                        ...
                        <tr>
                          <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                            <div style="font-family:Roboto, Helvetica, sans-serif;font-size:13px;line-height:1;text-align:left;color:#ffffff;"></div>
                          </td>
                        </tr>
                      </tbody>
                    </table>
  ...
  protected getManageLink(): string {
    ...
    return `<a style="color: #e3c050; text-decoration: none;" href="${manageLink}" target="_blank">${manageText} <img src="${linkIcon()}" width="12px"></img></a>`;
  }
}
