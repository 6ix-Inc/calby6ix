...
export const emailSchedulingBodyHeader = (headerType: BodyHeadType): string => {
  ...
  <div style="background:#FFFFFF;background-color:#FFFFFF;margin:0px auto;max-width:600px;">
    <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="background:#FFFFFF;background-color:#FFFFFF;width:100%;">
      <tbody>
        <tr>
          <td style="border-left:1px solid #373737;border-right:1px solid #373737;border-top:1px solid #373737;direction:ltr;font-size:0px;padding:30px 20px 0 20px;text-align:center;">
